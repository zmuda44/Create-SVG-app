...
describe('Text content and color', () => {
  ...
  describe('Text color', () => {
    it('I should see the text in the proper color', () => {
      const correctTextColor = `<text x="150" y="125" font-size="60" text-anchor="middle" fill="red">baa</text>`;
  ...
  describe('Text shape not triangle', () => {
    it('I should see that the text is properly centered for all shapes except triangle', () => {
      const correctTextColor = `<text x="150" y="125" font-size="60" text-anchor="middle" fill="blue">baa</text>`;
