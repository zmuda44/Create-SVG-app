...
describe('Shape and color check', () => {
  ...
  describe('Blue Circle', () => {
    it('I should see that the code matches to create the correct shape with the correct color', () => {
      const correctShape = `<circle cx="150" cy="105" r="80" fill="blue" />`;
  ...
  describe('Blue Square', () => {
    it('I should see that the code matches to create the correct shape with the correct color', () => {
      const correctShape = `<rect x="75" y="30" width="150" height="150" fill="blue"/>`;
  ...
  describe('Yellow RoundedSquare', () => {
    it('I should see that the code matches to create the correct shape with the correct color', () => {
      const correctShape = `<rect x="75" y="30" rx="20" ry="20" width="150" height="150" fill="yellow"/>`;
